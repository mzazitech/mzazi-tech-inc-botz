...
let trashplug = async (m, { trashown,text,mzazi,reply,isAdmins,prefix, command }) => {
				...
				await mzazi.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(mess.succes)).catch((err) => reply(mess.error))
			};
