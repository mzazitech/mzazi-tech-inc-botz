...
let trashplug = async (m, { mzazi,trashown, reply, text, example }) => {
...
if (!fs.existsSync("./mzaziplugs/" + text.toLowerCase())) return reply("sucess!")
let res = await fs.readFileSync("./mzaziplugs/" + text.toLowerCase())
